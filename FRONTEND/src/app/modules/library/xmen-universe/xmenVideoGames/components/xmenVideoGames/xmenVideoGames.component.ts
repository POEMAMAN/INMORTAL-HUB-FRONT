...
@Component({
  selector: 'app-xmenVideoGames',
  templateUrl: './xmenVideoGames.component.html',
  styleUrls: ['./xmenVideoGames.component.scss']
})
export class xmenVideoGamesComponent implements OnInit {
@Input() xmenVideoGame: any
...
clickCard() {
  const clickcardElement = this.elementRef.nativeElement.querySelector('.xmenVideoGames-container-deck-card');

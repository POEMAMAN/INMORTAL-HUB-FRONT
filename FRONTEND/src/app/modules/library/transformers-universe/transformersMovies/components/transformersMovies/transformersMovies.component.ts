...
@Component({
  selector: 'app-transformersMovies',
  templateUrl: './transformersMovies.component.html',
  styleUrls: ['./transformersMovies.component.scss']
})
export class transformersMoviesComponent implements OnInit {
@Input() transformersMovie: any
...
clickCard() {
  const clickcardElement = this.elementRef.nativeElement.querySelector('.transformersMovies-container-deck-card');

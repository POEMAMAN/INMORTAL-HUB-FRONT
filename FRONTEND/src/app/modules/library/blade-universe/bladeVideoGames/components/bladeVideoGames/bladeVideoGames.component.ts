...
@Component({
  selector: 'app-bladeVideoGames',
  templateUrl: './bladeVideoGames.component.html',
  styleUrls: ['./bladeVideoGames.component.scss']
})
export class bladeVideoGamesComponent implements OnInit {
@Input() bladeVideoGame: any
...
clickCard() {
  const clickcardElement = this.elementRef.nativeElement.querySelector('.bladeVideoGames-container-deck-card');

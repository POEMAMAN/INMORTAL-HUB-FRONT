...
@Component({
  selector: 'app-starWarsBooks',
  templateUrl: './starWarsBooks.component.html',
  styleUrls: ['./starWarsBooks.component.scss']
})
export class starWarsBooksComponent implements OnInit {
 
  @Input() starWarsBook: any
isAdmin: boolean = false;
  ...
  clickCard() {
    const clickcardElement = this.elementRef.nativeElement.querySelector('.starWarsBooks-container-deck-card');

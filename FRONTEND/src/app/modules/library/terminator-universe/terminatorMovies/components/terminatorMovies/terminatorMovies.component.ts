...
@Component({
  selector: 'app-terminatorMovies',
  templateUrl: './terminatorMovies.component.html',
  styleUrls: ['./terminatorMovies.component.scss']
})
export class terminatorMoviesComponent implements OnInit {
@Input() terminatorMovie: any
...
clickCard() {
  const clickcardElement = this.elementRef.nativeElement.querySelector('.terminatorMovies-container-deck-card');

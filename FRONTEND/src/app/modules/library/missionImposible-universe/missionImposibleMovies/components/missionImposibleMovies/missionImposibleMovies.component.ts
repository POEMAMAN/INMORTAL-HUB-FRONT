...
@Component({
  ...
  templateUrl: './missionImposibleMovies.component.html',
  styleUrls: ['./missionImposibleMovies.component.scss']
})
...
clickCard() {
  const clickcardElement = this.elementRef.nativeElement.querySelector('.missionImposibleMovies-container-deck-card');

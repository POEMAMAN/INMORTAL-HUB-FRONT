...
@Component({
  selector: 'app-residentEvilMovies',
  templateUrl: './residentEvilMovies.component.html',
  styleUrls: ['./residentEvilMovies.component.scss']
})
export class residentEvilMoviesComponent implements OnInit {
@Input() residentEvilMovie: any
...
clickCard() {
  const clickcardElement = this.elementRef.nativeElement.querySelector('.residentEvilMovies-container-deck-card');

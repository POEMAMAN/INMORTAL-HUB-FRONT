...
@Component({
  selector: 'app-matrixVideoGames',
  templateUrl: './matrixVideoGames.component.html',
  styleUrls: ['./matrixVideoGames.component.scss']
})
export class matrixVideoGamesComponent implements OnInit {
@Input() matrixVideoGame: any
...
clickCard() {
  const clickcardElement = this.elementRef.nativeElement.querySelector('.matrixVideoGames-container-deck-card');

...
dotenv.config();
const BookStarsWars = require('../../api/models/models.StarWars/books.StarWars.model');


const arrayBooksStarsWars = [{
        ...
        picture: 'https://console.cloudinary.com/console/c-19d7767fc54f15bca4427ebedd8a4a/media_library/folders/c71f237e310920781cce2a09fd21f2d6e2/asset/baaa8f7abe61c82dea869dd3bb6ed248/manage?view_mode=mosaic&context=manage',
    },
    {
        ...
        picture: 'https://console.cloudinary.com/console/c-19d7767fc54f15bca4427ebedd8a4a/media_library/folders/c71f237e310920781cce2a09fd21f2d6e2/asset/fa1bced473344a5da0d7f25991a61319/manage?view_mode=mosaic&context=manage',
    },
    {
        ...
        picture: 'https://console.cloudinary.com/console/c-19d7767fc54f15bca4427ebedd8a4a/media_library/folders/c71f237e310920781cce2a09fd21f2d6e2/asset/6d7ad59594b56c01b85cdf2a7514c08b/manage?view_mode=mosaic&context=manage',
    },
    {
        ...
        picture: 'https://console.cloudinary.com/console/c-19d7767fc54f15bca4427ebedd8a4a/media_library/folders/c71f237e310920781cce2a09fd21f2d6e2/asset/87c6443a99a96d9a11b87ffc39eace65/manage?view_mode=mosaic&context=manage',
    },
    {
        ...
        picture: 'https://console.cloudinary.com/console/c-19d7767fc54f15bca4427ebedd8a4a/media_library/folders/c71f237e310920781cce2a09fd21f2d6e2/asset/5e2afcbdc167eea3d28aba9b041dc7a0/manage?view_mode=mosaic&context=manage',
    },
    {
        ...
        picture: 'https://console.cloudinary.com/console/c-19d7767fc54f15bca4427ebedd8a4a/media_library/folders/c71f237e310920781cce2a09fd21f2d6e2/asset/a688ed9b86c5d414f4c542d39910fe4d/manage?view_mode=mosaic&context=manage',
    },
]
mongoose
    ...
    .then(async() => {
        const allBooksStarsWars = await BookStarsWars.find();
        if (allBooksStarsWars.length > 0) {
            await BookStarsWars.collection.drop();
    ...
    .then(async() => {
        const booksStarsWarsMap = arrayBooksStarsWars.map((book) => new BookStarsWars(book));
        await BookStarsWars.insertMany(booksStarsWarsMap);

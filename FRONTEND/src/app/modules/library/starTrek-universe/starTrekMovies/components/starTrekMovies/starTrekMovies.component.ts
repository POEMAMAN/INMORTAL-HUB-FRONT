...
@Component({
  selector: 'app-starTrekMovies',
  templateUrl: './starTrekMovies.component.html',
  styleUrls: ['./starTrekMovies.component.scss']
})
export class starTrekMoviesComponent implements OnInit {
@Input() starTrekMovie: any
...
ngOnInit(): void {
  ...
  clickCard() {
    const clickcardElement = this.elementRef.nativeElement.querySelector('.starTrekMovies-container-deck-card');

...
@Component({
  selector: 'app-indianaJonesMovies',
  templateUrl: './indianaJonesMovies.component.html',
  styleUrls: ['./indianaJonesMovies.component.scss']
})
export class indianaJonesMoviesComponent implements OnInit {
@Input() indianaJonesMovie: any
...
ngOnInit(): void {
  ...
  clickCard() {
    const clickcardElement = this.elementRef.nativeElement.querySelector('.indianaJonesMovies-container-deck-card');
